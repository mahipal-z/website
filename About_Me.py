...
\nor Bowling :bowling:, Lifting Weights :man_lifting_weights:, Card games, Board games :game_die:, or for Cooking
\nor you are willing to teach me Swimming :man_swimming:, Pool :8ball:, or Piano :musical_keyboard:
""")
#    st.markdown()
